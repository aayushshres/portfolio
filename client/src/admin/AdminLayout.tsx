...
export default function AdminLayout() {
  ...
  return (
    <div className="min-h-dvh flex flex-col md:grid md:grid-cols-[16rem_1fr] bg-zinc-950 text-zinc-100">
      <aside className="border-b md:border-b-0 md:border-r border-zinc-800 p-4 md:p-5 flex flex-col gap-4 md:gap-6">
        ...
        <nav className="flex overflow-x-auto md:flex-col gap-2 pb-2 md:pb-0 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
