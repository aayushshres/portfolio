/**
 * Client-side default data — mirrors server/src/lib/defaults.ts.
 * Used as fallback when the API server is unavailable, so the public
 * site always renders content.
 */

import type { Profile } from "@/hooks/useProfile";
import type { Social } from "@/hooks/useSocials";
import type { Project } from "@/hooks/useProjects";
import type { ResearchItem } from "@/hooks/useResearch";
import type { PublicationItem } from "@/hooks/usePublications";
